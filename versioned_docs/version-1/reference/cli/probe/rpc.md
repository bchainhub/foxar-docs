...
```bash
$ probe rpc --help
Usage: probe rpc [OPTIONS] <METHOD> [PARAMS]...
...
Arguments:
  ...
  [PARAMS]...
          ...
          probe rpc eth_getBlockByNumber 0x123 false => {"method": "eth_getBlockByNumber", "params": ["0x123", false] ... }
...
Options:
  -w, --raw
          ...
          probe rpc eth_getBlockByNumber '["0x123", false]' --raw => {"method": "eth_getBlockByNumber", "params": ["0x123", false] ... }
